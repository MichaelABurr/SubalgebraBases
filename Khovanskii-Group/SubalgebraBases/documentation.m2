...
doc ///
   ...
   Description
     Text 
        This function attempts to write @TT "f"@ in terms of the generators of @TT "subR"@.  Internally, this function calculates a Groebner basis.  Doubts have been expressed about the theoretical basis of this function.
     Example
       gndR = QQ[x];
